...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [97.934111, 1.555388, 100.444015, 3.579799], maxZoom: 25, minZoom: 2, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([97.934111, 1.555388, 100.444015, 3.579799], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Peta_Desa_Rawan_Bencana_Alam_Banjir_Sumatera_Utara_4,
    colName: 'NAMA DESA',
    zoom: 10,
    collapsed: true,
    map: map
